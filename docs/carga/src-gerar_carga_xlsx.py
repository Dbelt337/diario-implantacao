...
carga = [
 ...
 ['3', 'Product2',
  ...
  'SapMaterialCode__c llega por el deploy (fila 0); backfill = MATNR también en los 250 existentes. Family distingue Vehículo / Repuesto / Accesorio. REGLA DEL CATÁLOGO (probada 12/08): los productos que serán PADRE de kit deben cargarse con Type=Bundle.'],
 ...
 ['7', 'ProductRelatedComponent',
  ...
  'DevSales: kit de prueba creado (SEED OK 12/08) · centenas al cargar',
  'REGLAS DEL CATÁLOGO probadas 12/08: ProductRelationshipTypeId = 0yoao0000019FldAAE (Bundle→BundleComponent), el padre con Type=Bundle (fila 3) e IsDefaultComponent=TRUE en cada componente (bundle estático).'],
 ['8', 'VehicleDefinition',
