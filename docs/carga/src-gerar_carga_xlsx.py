...
carga = [
 ...
 ['9', 'Vehicle',
  ...
  'Name, VehicleDefinitionId, VehicleIdentificationNumber (VIN — API name confirmado), Status + vínculo con el centro (DECISIÓN ABIERTA)',
  ...
  'GAPCHECK: Vehicle NO tiene lookup nativo a Location — solo el campo compuesto de dirección (Location ADDRESS). Candidato nativo por verificar: Asset.LocationId (GAPCHECK3); si tampoco existe, crear lookup custom Vehicle → Location (única creación de campo de todo el plan).'],
 ['10', 'Asset',
