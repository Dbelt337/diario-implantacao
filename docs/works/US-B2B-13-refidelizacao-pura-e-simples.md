...
RN-06 Aditivo de tempo gerado pelo Amend do Industries CLM (TEC-CLM-01) com contract type próprio "Aditivo de Refidelização": o aditivo nasce ligado ao contrato master (lista Amendment Contracts) e ao registro que o originou. Como o Amend não copia os termos gerais, o template do aditivo carrega as cláusulas de renovação. Aceite pelo signatário legal conforme B2B-09.
RN-07 Aprovação obrigatória do BKO (Approval Process com record lock) após o aceite e antes da sincronização com o legado; o BKO só lê, não edita valores (W-000101).
...
RN-11 Desconto de fidelidade: quando o preço vigente tiver ajuste com Time Plan/Time Policy (ABP, Source = ABP), a nova duração exige reprecificação das linhas do asset (Reprice Existing Prices). Confirmar mecânica na página de Reprice antes do desenvolvimento (pendência técnica P-A).
...
Dependências: W-000123 (B2B-10, ponto de entrada), W-000100 (regras de prazo e justificativa), W-000126 (TEC-CLM-01 aditivo), W-000122 (B2B-09 signatário), W-000101 (fila BKO), W-000087 (integrações), W-000103 (Assets com fidelidade carregada), P1 do Joel (prazo de contrato na oferta), página Reprice Existing Prices (P-A).
...
| Critério 6 — BKO obrigatório | New | Dado o aditivo aceito, quando o BKO ainda não aprovou, então nenhuma chamada ao Customer Core é feita e o contrato permanece com os dados anteriores. |
