...
/**
 * All countries. Thin business-line UI (Venta de Productos de Acabado). Reuses the Apex service
 ...
 */
export default class AgriculturalProductsSale extends LightningElement {
    @api recordId;
